			...
			<div class="panel-body">
				<form method="post" action="">
					...
					<div class="form-group">
						...
						<input type="text" name="design_pro" class="form-control" required="required">
					</div>
					<div class="form-group">
						<label class="control-label">
							PU(CDF)
						</label>
						<input type="number" name="pu_pro" class="form-control" required="required">
					</div>
					<div class="form-group">
						<label class="control-label">
							QTE STOCK
						</label>
						<input type="number" name="qte_stock" class="form-control" required="required">
					</div>
					<div class="form-group">
						<label class="control-label">
							CATEGORIE
