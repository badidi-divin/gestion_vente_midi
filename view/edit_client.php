			...
			<div class="panel-body">
				<form method="post" action="">
					...
					<div class="form-group">
						...
						<input type="text" name="nom" class="form-control" required="required" value="<?= $userinfo['nom_complet']; ?>">
					</div>
					<div class="form-group">
						<label class="control-label">
							Sexe
					...
					<div class="form-group">
						...
						<input type="number" name="tel" class="form-control" required="required" value="<?= $userinfo['tel']; ?>">
					</div>
					<div class="form-group">
						<label class="control-label">
							Email
					...
					<div class="form-group">
						...
						<input type="text" name="adresse" class="form-control" required="required" value="<?= $userinfo['adresse']; ?>">
					</div>
					<div class="form-group">
						<label class="control-label">
							Type Client
